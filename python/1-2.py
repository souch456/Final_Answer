...
driver = webdriver.Chrome(executable_path="/Users/matsuosouichirou/Downloads/chromedriver")
...
df = pd.DataFrame(
    data={'店舗名':store_names, '電話番号':phone_numbers, 'メールアドレス':mail_address, '都道府県':prefectures, '市区町村':municipalities, '番地':house_number, '建物名':buildings, 'URL':store_URL, 'SSL':store_SSL}
)
